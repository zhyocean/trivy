...
function create_common_rpm_repo () {
        ...
        for arch in ${ARCHES[@]}; do
                ...
                createrepo_c -u https://github.com/zhanglimao/trivy/releases/download/ --location-prefix="v"$TRIVY_VERSION --update $rpm_path/$arch
...
function create_rpm_repo () {
        ...
        createrepo_c -u https://github.com/zhanglimao/trivy/releases/download/ --location-prefix="v"$TRIVY_VERSION --update $rpm_path
